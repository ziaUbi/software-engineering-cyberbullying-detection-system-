...
class TestingOrchestrator:
    ...
    def test(self):
        ...
        if self.service_flag:
            ...
            JsonHandlerValidator.validate_json("inputs/winner_network.json","schemas/winner_network_schema.json")
            data = JsonHandlerValidator.read_json_file("inputs/winner_network.json")
        ...
        test_set = LearningSets.get_test_set("data/test_set.sav")
        ...
        for file_path in glob.glob("data/classifier*.sav"):
